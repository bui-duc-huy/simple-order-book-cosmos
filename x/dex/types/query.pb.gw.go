...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"orderbook", "dex", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Order_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"orderbook", "dex", "order", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_OrderAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"orderbook", "dex", "order"}, "", runtime.AssumeColonVerbOpt(true)))
)
